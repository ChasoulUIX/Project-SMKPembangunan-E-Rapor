...
function filterData() {
    ...
    rows.forEach(row => {
        ...
        const kelasMatch = !kelas || row.cells[2].textContent.includes(kelas);
        const mapelMatch = !mapel || row.cells[4].textContent === mapel;
        // Add tahun ajaran matching logic when you add that column to your table data
