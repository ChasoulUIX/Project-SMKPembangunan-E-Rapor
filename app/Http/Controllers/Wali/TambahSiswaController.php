...
class TambahSiswaController extends Controller
{
    public function index()
    {
        $murids = Murid::all();
        $kelas = Kelas::all();
        return view('wali.pages.tambahsiswa', compact('murids', 'kelas'));
    }

    public function create()
    {
        $kelas = Kelas::all();
        return view('wali.pages.tambahsiswa', compact('kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('wali.tambahsiswa.index')->with('success', 'Siswa berhasil ditambahkan');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function show($nis)
    {
        ...
        $kelas = Kelas::all();
        return view('wali.pages.tambahsiswa', compact('murid', 'kelas'));
    }
    ...
    public function update(Request $request, $nis)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('wali.tambahsiswa.index')->with('success', 'Data siswa berhasil diperbarui');
        } catch (\Exception $e) {
            DB::rollback();
